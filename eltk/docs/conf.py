# -*- coding: utf-8 -*-
#
# ELTK documentation build configuration file, created by
# sphinx-quickstart on Wed Jul 15 22:14:45 2009.
#
...
#sys.path.append(os.path.abspath('/home/farrar/svn_projects/eltk/trunk/eltk/'))
