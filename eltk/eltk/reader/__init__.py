...
"""
Various readers are used to migrate  so-called 'legacy data', ie files that are not yet in a format compatible with the GOLD Community of Practice. For each type of legacy data file/format, a new reader class will need to be written. For instance, there are readers for:
